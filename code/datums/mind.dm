...
/datum/mind/proc/edit_memory()
	...
	if (istype(current, /mob/living/carbon/human))
		/** Impanted**/
		if(isloyal(H))
			text = "Loyalty Implant:<a href='?src=[UID()];implant=remove'>Remove</a>|<b>Implanted</b></br>"
		else
			text = "Loyalty Implant:<b>No Implant</b>|<a href='?src=[UID()];implant=add'>Implant him!</a></br>"
		...
		if (isloyal(H))
			...
			text = "<a href='?src=[UID()];revolution=clear'>employee</a>|<b>HEADREV</b>|<a href='?src=[UID()];revolution=rev'>rev</a>"
			...
			text += "<a href='?src=[UID()];revolution=clear'>employee</a>|<a href='?src=[UID()];revolution=headrev'>headrev</a>|<b>REV</b>"
		else
			text += "<b>EMPLOYEE</b>|<a href='?src=[UID()];revolution=headrev'>headrev</a>|<a href='?src=[UID()];revolution=rev'>rev</a>"
		...
		if (isloyal(H))
			...
			text += "<a href='?src=[UID()];cult=clear'>employee</a>|<b>CULTIST</b>"
...
*/
			...
			text += "<b>EMPLOYEE</b>|<a href='?src=[UID()];cult=cultist'>cultist</a>"
		...
		if (src in ticker.mode.wizards)
			text += "<b>YES</b>|<a href='?src=[UID()];wizard=clear'>no</a>"
			...
			text += "<a href='?src=[UID()];wizard=wizard'>yes</a>|<b>NO</b>"
		...
		if (src in ticker.mode.changelings)
			text += "<b>YES</b>|<a href='?src=[UID()];changeling=clear'>no</a>"
			if (objectives.len==0)
			...
			text += "<a href='?src=[UID()];changeling=changeling'>yes</a>|<b>NO</b>"
		...
		if (src in ticker.mode.vampires)
			text += "<b>YES</b>|<a href='?src=[UID()];vampire=clear'>no</a>"
			if (objectives.len==0)
				text += "<br>Objectives are empty! <a href='?src=[UID()];vampire=autoobjectives'>Randomize!</a>"
		else
			text += "<a href='?src=[UID()];vampire=vampire'>yes</a>|<b>NO</b>"

		/** Enthralled ***/
		text += "<br><b>enthralled</b>"
		text = "<i><b>[text]</b></i>: "
		if(src in ticker.mode.vampire_enthralled)
			text += "<b><font color='#FF0000'>YES</font></b>|<a href='?src=[UID()];vampthrall=clear'>no</a>"
		else
		...
		if (src in ticker.mode.red_deities)
			text += "<b>RED GOD</b>|<a href='?src=[UID()];handofgod=red prophet'>red prophet</a>|<a href='?src=[UID()];handofgod=red follower'>red follower</a>|<a href='?src=[UID()];handofgod=clear'>employee</a>|<a href='?src=[UID()];handofgod=blue god'>blue god</a>|<a href='?src=[UID()];handofgod=blue prophet'>blue prophet</a>|<a href='?src=[UID()];handofgod=blue follower'>blue follower</a>"
		else if(src in ticker.mode.red_deity_prophets)
			text += "<a href='?src=[UID()];handofgod=red god'>red god</a>|<b>RED PROPHET</b>|<a href='?src=[UID()];handofgod=red follower'>red follower</a>|<a href='?src=[UID()];handofgod=clear'>employee</a>|<a href='?src=[UID()];handofgod=blue god'>blue god</a>|<a href='?src=[UID()];handofgod=blue prophet'>blue prophet</a>|<a href='?src=[UID()];handofgod=blue follower'>blue follower</a>"
		else if (src in ticker.mode.red_deity_followers)
			text += "<a href='?src=[UID()];handofgod=red god'>red god</a>|<a href='?src=[UID()];handofgod=red prophet'>red prophet</a>|<b>RED FOLLOWER</b>|<a href='?src=[UID()];handofgod=clear'>employee</a>|<a href='?src=[UID()];handofgod=blue god'>blue god</a>|<a href='?src=[UID()];handofgod=blue prophet'>blue prophet</a>|<a href='?src=[UID()];handofgod=blue follower'>blue follower</a>"
		else if (src in ticker.mode.blue_deities)
			text += "<a href='?src=[UID()];handofgod=red god'>red god</a>|<a href='?src=[UID()];handofgod=red prophet'>red prophet</a>|<a href='?src=[UID()];handofgod=red follower'>red follower</a>|<a href='?src=[UID()];handofgod=clear'>employee</a>|<b>BLUE GOD</b>|<a href='?src=[UID()];handofgod=blue prophet'>blue prophet</a>|<a href='?src=[UID()];handofgod=blue follower'>blue follower</a>"
		else if (src in ticker.mode.blue_deity_prophets)
			text += "<a href='?src=[UID()];handofgod=red god'>red god</a>|<a href='?src=[UID()];handofgod=red prophet'>red prophet</a>|<a href='?src=[UID()];handofgod=red follower'>red follower</a>|<a href='?src=[UID()];handofgod=clear'>employee</a>|<a href='?src=[UID()];handofgod=blue god'>blue god</a>|<b>BLUE PROPHET</b>|<a href='?src=[UID()];handofgod=blue follower'>blue follower</a>"
		else if (src in ticker.mode.blue_deity_followers)
			text += "<a href='?src=[UID()];handofgod=red god'>red god</a>|<a href='?src=[UID()];handofgod=red prophet'>red prophet</a>|<a href='?src=[UID()];handofgod=red follower'>red follower</a>|<a href='?src=[UID()];handofgod=clear'>employee</a>|<a href='?src=[UID()];handofgod=blue god'>blue god</a>|<a href='?src=[UID()];handofgod=blue prophet'>blue prophet</a>|<b>BLUE FOLLOWER</b>"
		else
			text += "<a href='?src=[UID()];handofgod=red god'>red god</a>|<a href='?src=[UID()];handofgod=red prophet'>red prophet</a>|<a href='?src=[UID()];handofgod=red follower'>red follower</a>|<B>EMPLOYEE</b>|<a href='?src=[UID()];handofgod=blue god'>blue god</a>|<a href='?src=[UID()];handofgod=blue prophet'>blue prophet</a>|<a href='?src=[UID()];handofgod=blue follower'>blue follower</a>"
		...
		if (src in ticker.mode.syndicates)
			text += "<b>OPERATIVE</b>|<a href='?src=[UID()];nuclear=clear'>nanotrasen</a>"
			...
			text += "<a href='?src=[UID()];nuclear=nuclear'>operative</a>|<b>NANOTRASEN</b>"
		...
		if (isloyal(H))
			...
			if (src in ticker.mode.traitors)
				text += "<b>TRAITOR</b>|<a href='?src=[UID()];traitor=clear'>EMPLOYEE</a>"
				if (objectives.len==0)
					text += "<br>Objectives are empty! <a href='?src=[UID()];traitor=autoobjectives'>Randomize</a>!"
			else
				text += "<a href='?src=[UID()];traitor=traitor'>traitor</a>|<b>EMPLOYEE</b>"
		...
		if(src in ticker.mode.shadows)
			text += "<b>SHADOWLING</b>|thrall|<a href='?src=[UID()];shadowling=clear'>human</a>"
		else if(src in ticker.mode.shadowling_thralls)
			text += "Shadowling|<b>THRALL</b>|<a href='?src=[UID()];shadowling=clear'>human</a>"
		else
			text += "<a href='?src=[UID()];shadowling=shadowling'>shadowling</a>|<a href='?src=[UID()];shadowling=thrall'>thrall</a>|<b>HUMAN</b>"
		...
		if(src in ticker.mode.abductors)
			text += "<b>Abductor</b>|<a href='?src=[UID()];abductor=clear'>human</a>"
			text += "|<a href='?src=[UID()];common=undress'>undress</a>|<a href='?src=[UID()];abductor=equip'>equip</a>"
		else
			text += "<a href='?src=[UID()];abductor=abductor'>Abductor</a>|<b>human</b>"
	...
	if (istype(current, /mob/living/silicon))
		...
		if (istype(current, /mob/living/silicon/ai))
			if (src in ticker.mode.malf_ai)
				text += "<b>MALF</b>|<a href='?src=[UID()];silicon=unmalf'>not malf</a>"
			else
				text += "<a href='?src=[UID()];silicon=malf'>malf</a>|<b>NOT MALF</b>"
		var/mob/living/silicon/robot/robot = current
		if (istype(robot) && robot.emagged)
			text += "<br>Cyborg: Is emagged! <a href='?src=[UID()];silicon=unemag'>Unemag!</a><br>0th law: [robot.laws.zeroth_law]"
