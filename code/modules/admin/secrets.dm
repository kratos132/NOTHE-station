		...
		if (0) // Debug
			if(check_rights(R_ADMIN,0))
				dat += {"
						...
						<A href='?src=[UID()];secretsfun=launchshuttle'>Launch a shuttle</A>&nbsp;&nbsp;
						<A href='?src=[UID()];secretsfun=forcelaunchshuttle'>Force launch a shuttle</A><BR>
						<A href='?src=[UID()];secretsfun=jumpshuttle'>Jump a shuttle</A>&nbsp;&nbsp;
						<A href='?src=[UID()];secretsfun=moveshuttle'>Move a shuttle</A><BR>
						<BR></center>
					"}
		...
		if (1)
			if(check_rights((R_EVENT|R_SERVER),0))
				dat += {"
					...
					<h2><B>IC Events</B></h2>
					<b>Teams</b><br>
					<A href='?src=[UID()];secretsfun=striketeam'>Send in a strike team</A>&nbsp;&nbsp;
					<A href='?src=[UID()];secretsfun=striketeam_syndicate'>Send in a syndicate strike team</A>&nbsp;&nbsp;
