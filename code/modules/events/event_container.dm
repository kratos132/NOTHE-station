...
/datum/event_container/moderate
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Gas Leak Fire",			/datum/event/fire/gas_leak,				100,	list(ASSIGNMENT_ENGINEER = 60)),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Electric Fire",			/datum/event/fire/electric,				50,		list(ASSIGNMENT_ENGINEER = 40)),
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Wood Fire",				/datum/event/fire/wood,					50,		list(ASSIGNMENT_ENGINEER = 40)),
