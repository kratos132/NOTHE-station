...
/obj/item/weapon/robot_module/proc/add_subsystems_and_actions(var/mob/living/silicon/robot/R)
	R.verbs |= subsystems
...
/obj/item/weapon/robot_module/proc/remove_subsystems_and_actions(var/mob/living/silicon/robot/R)
	R.verbs -= subsystems
