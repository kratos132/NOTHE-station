...
/obj/machinery/ai_slipper/attack_hand(mob/user as mob)
	...
	if(src.locked && (!istype(user, /mob/living/silicon)))
		...
		t += "Dispenser [disabled ? "deactivated" : "activated"] - <A href='?src=[UID()];toggleOn=1'>[disabled ? "Enable" : "Disable"]?</a><br>\n"
		t += "Uses Left: [uses]. <A href='?src=[UID()];toggleUse=1'>Activate the dispenser?</A><br>\n"
