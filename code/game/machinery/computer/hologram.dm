...
/obj/machinery/computer/hologram_comp/proc/show_console(var/mob/user as mob)
	...
	if (src.temp)
		dat = "[temp]<BR><BR><A href='?src=[UID()];temp=1'>Clear</A>"
	else
		dat = {"<B>Hologram Status:</B><HR>\n
			Power: <A href='?src=[UID()];power=1'>[projector.hologram ? "On" : "Off"]</A><HR>\n
			<B>Hologram Control:</B><BR>\n
			Color Luminosity: [-lumens + 35]/220 <A href='?src=[UID()];reset=1'>\[Reset\]</A><BR>\n
			...
			<BR>\nHair Color: ([h_r],[h_g],[h_b]) <A href='?src=[UID()];h_reset=1'>\[Reset\]</A><BR>\n
			Red (0-255): <A href='?src=[UID()];h_r=-300'>\[0\]</A> <A href='?src=[UID()];h_r=-10'>-10</A> <A href='?src=[UID()];h_r=-1'>-1</A> [h_r] <A href='?src=[UID()];h_r=1'>1</A> <A href='?src=[UID()];h_r=10'>10</A> <A href='?src=[UID()];h_r=300'>\[255\]</A><BR>\n
			Green (0-255): <A href='?src=[UID()];h_g=-300'>\[0\]</A> <A href='?src=[UID()];h_g=-10'>-10</A> <A href='?src=[UID()];h_g=-1'>-1</A> [h_g] <A href='?src=[UID()];h_g=1'>1</A> <A href='?src=[UID()];h_g=10'>10</A> <A href='?src=[UID()];h_g=300'>\[255\]</A><BR>\n
			Blue (0-255): <A href='?src=[UID()];h_b=-300'>\[0\]</A> <A href='?src=[UID()];h_b=-10'>-10</A> <A href='?src=[UID()];h_b=-1'>-1</A> [h_b] <A href='?src=[UID()];h_b=1'>1</A> <A href='?src=[UID()];h_b=10'>10</A> <A href='?src=[UID()];h_b=300'>\[255\]</A><BR>
			"}
