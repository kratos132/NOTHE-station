...
/datum/job/captain
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "Oficiais da Federação"
	...
	equip(var/mob/living/carbon/human/H)
		...
		captain_announcement.Announce("Tudo sobre controle, Capitão [H.real_name] no deck!")
...
/datum/job/hop
	title = "Chefe da Staff"
	flag = HOP
	department_flag = SUPPORT
	total_positions = 1
	spawn_positions = 1
	supervisors = "o capitão"
...
/datum/job/nanotrasenrep
	title = "Representante da Federação"
	flag = NANO
	department_flag = KARMA
	total_positions = 1
	spawn_positions = 1
	supervisors = "a staff de comando"
	selection_color = "#ddddff"
...
/datum/job/blueshield
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "o representante da federação"
	selection_color = "#ddddff"
	idtype = /obj/item/weapon/card/id/nanotrasen
	req_admin_notify = 1
	minimal_player_age = 21
...
/datum/job/judge
	...
	total_positions = 1
	spawn_positions = 1
	supervisors = "a corte suprema da Federação"
	selection_color = "#ddddff"
	idtype = /obj/item/weapon/card/id/nanotrasen
	req_admin_notify = 1
	minimal_player_age = 30
