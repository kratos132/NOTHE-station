...
/datum/job/scientist
	...
	minimal_access = list(access_robotics, access_tech_storage, access_morgue, access_tox, access_tox_storage, access_research, access_xenobiology, access_xenoarch, access_maint_tunnels, access_mineral_storeroom)
