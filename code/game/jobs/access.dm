...
/proc/get_centcom_access(job)
	switch(job)
		...
		if("Observador do Thunderdome")
			return list(access_cent_general, access_cent_thunder)
		if("Membro da Equipe de Atendimento a Emergências")
		...
		if("Líder da Equipe de Atendimento a Emergências")
		...
		if("Oficial da Deathsquad")
			return get_all_centcom_access() + get_all_accesses()
		if("Oficial de Operações Especiais")
			return get_all_centcom_access() + get_all_accesses()
		if("Representante da Marinha Espacial")
			return get_all_centcom_access() + get_all_accesses()
		if("Oficial da Marinha Espacial")
			return get_all_centcom_access() + get_all_accesses()
		if("Capitão da Marinha Espacial")
			return get_all_centcom_access() + get_all_accesses()
		if("Comandante Supremo")
			return get_all_centcom_access() + get_all_accesses()
