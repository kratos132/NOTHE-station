...
/obj/machinery/abductor/console/attack_hand(mob/user)
	...
	if(experiment != null)
		...
		dat += "<a href='[UID()];dispense=baton'>Advanced Baton</A><br>"
		dat += "<a href='[UID()];dispense=helmet'>Agent Helmet</A><br>"
		dat += "<a href='[UID()];dispense=silencer'>Radio Silencer</A><br>"
		dat += "<a href='[UID()];dispense=tool'>Science Tool</A><br>"
	else
	...
	if(pad!=null)
		...
		dat += "<a href='[UID()];teleporter_send=1'>Activate Teleporter</A><br>"
		if(gizmo!=null && gizmo.marked!=null)
			dat += "<a href='[UID()];teleporter_retrieve=1'>Retrieve Mark</A><br>"
		else
	...
	if(vest!=null)
		...
		if(mode == VEST_STEALTH)
			dat += "<a href='[UID()];flip_vest=1'>Combat</A>"
			dat += "<span class='linkOff'>Stealth</span>"
		else
			dat += "<span class='linkOff'>Combat</span>"
			dat += "<a href='[UID()];flip_vest=1'>Stealth</A>"
