...
/obj/item/weapon/contraband/poster
	...
	desc = "The poster comes with its own automatic adhesive mechanism, for easy pinning to any vertical surface. Its vulgar themes have marked it as contraband aboard FG space facilities."
...
obj/structure/sign/poster/New(serial,var/subtypeIn = -1)
	...
	if(subtype == 0)
		...
		switch(serial_number)
			...
			if(9)
				name += " - Missing Gloves"
				desc += " This poster is about the uproar that followed FG's financial cuts towards insulated-glove purchases."
			if(10)
				name += " - Hacking Guide"
				desc += " This poster details the internal workings of the common Federation airlock."
			if(11)
				name += " - RIP Badger"
			...
			if(23)
				name += " - Rebels Unite!"
				desc += " A poster telling the viewer to rebel against Federation."
			if(24)
	...
	if(subtype == 1)
		...
		switch(serial_number)
			...
			if(2)
				...
				desc += " A poster depicting the logo of Federation."
			if(3)
				name += " - Cleanliness"
			...
			if(26)
				...
				desc += " A reprint of a poster from 2504, commemorating the 50th Aniversery of Fgposters Manufacturing, a subsidary of Federation."
			if(27)
				name += " - Fruit Bowl"
				desc += " Simple, yet awe inspiring."
			if(28)
				name += " - GalaxPDA 1000 Advertisment"
				desc += " A poster advertising the latest PDA from Federation."
			if(29)
				name += " - Enlist"
				desc += " Enlist in the Federation ERT reserves today!"
			if(30)
...
/obj/item/weapon/contraband/poster/legit
	desc = "The poster comes with its own automatic adhesive mechanism, for easy pinning to any vertical surface. It's contents go through FG's strict content guidlines."
