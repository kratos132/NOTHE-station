...
/obj/item/areaeditor/permit
	...
	fluffnotice = "Federation Engineering requires all on-station construction projects to be approved by a head of staff, as detailed in Federation Company Regulation 512-C (Mid-Shift Modifications to Company Property). \
...
/obj/item/areaeditor/blueprints
	...
	icon = 'icons/obj/items.dmi'
	icon_state = "blueprints"
	fluffnotice = "Property of Federation. For heads of staff only. Store in high-secure storage."
	w_class = 3
