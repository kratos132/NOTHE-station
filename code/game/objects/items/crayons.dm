...
/obj/item/toy/crayon
	...
	var/drawtype = "rune"
	var/list/graffiti = list("body","amyjon","face","matt","revolution","engie","guy","end","dwarf","uboa","up","down","left","right","heart","borgsrogue","voxpox","shitcurity","catbeast","hieroglyphs1","hieroglyphs2","hieroglyphs3","security","syndicate1","syndicate2","federation","lie","valid")
...
/obj/item/toy/crayon/spraycan/New()
	..()
	name = "Galactic Federation-brand Rapid Paint Applicator"
	update_icon()
