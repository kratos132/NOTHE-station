...
/obj/item/weapon/card/id/lifetime
	...
	desc = "A modified ID card given only to those people who have devoted their lives to the better interests of Federation. It sparkles blue."
...
/proc/get_centcom_card_skins()
	return list("centcom","centcom_old","federation","ERT_leader","ERT_empty","ERT_security","ERT_engineering","ERT_medical","ERT_janitorial","deathsquad","commander","syndie","TDred","TDgreen")
