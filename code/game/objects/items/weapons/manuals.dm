...
/obj/item/weapon/book/manual/security_space_law
	name = "Space Law"
	desc = "A set of FG guidelines for keeping law and order on their space stations."
	...
	dat = {"
		...
		<html>
                ...
                <ul>
                    ...
                    <li>CentComm Authorisation is required for hiring the following: Blueshield, Security Pod Pilot, Magistrate, Brig Physician, Federation Representative, Mechanic.</li>
	...
	dat = {"
		...
		<html>
				...
				<ol>
					...
					<li><a href="#ntrep">Federation Representative</a></li>
				...
				<ol>
					...
					<li>The Captain, despite being in charge of the Cyberiad, is not independent from Federation. Any attempts to disregard general company policy are to be considered an instant condition for contract termination;</li>
				...
				<ol>
					...
					<li>The Head of Personnel may not promote any personnel to the following Jobs without authorization from Central Command: Barber, Brig Physician, Federation Representative, Blueshield, Security Pod Pilot, Mechanic and Magistrate; (This is due to them being karma locked. Do not promote people to these positions without approval from the Administrators);</li>
				...
				<h1><a name="ntrep"><B>Federation Representative</B></a></h1><BR>
				<ol>
					<li>The Federation Representative is to ensure that every Department is following Standard Operating Procedure, up to and including the respective Head of Staff. If a Head of Staff is not available for a Department, the Federation Representative must ensure that the Captain appoints an Acting Head of Staff for said Department;</li>
					<li>The Federation Representative must attempt to resolve any breach of Standard Operating Procedure locally before contacting Central Command. This is an imperative: Standard Operating Procedure should always be followed unless there is a very good reason not to;</li>
					<li>The Federation Representative must, together with the Magistrate and Head of Security, ensure that Space Law is being followed and correctly applied;</li>
					<li>The Federation Representative may not threaten the use of a fax in order to gain leverage over any personnel, up to and including Command. In addition they may not threaten to fire, or have Central Command, fire anyone, unless they actually possess a demotion note;</li>
					<li>The Federation Representative is permitted to carry their Stun-Cane, or a Telescopic Baton if the Stun-Cane is lost.</li>
				</ol><BR>
				...
				<ol>
                    ...
                    <li>Any use of the "Purge" Module is to be followed by the upload of a Federation-approved Lawset immediately. AI Units must be bound to a Lawset at all times.</li>
				</ol><BR>
				</body>
				</html>
